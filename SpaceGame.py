...
# Splash screen
pen.goto(0, 200)
pen.write("SPACE ATTAK", align="center", font=("Courier", 30, "normal"))
pen.goto(0, 150)
pen.write("Uccidi i nemici rossi con i tuoi missili.", align="center", font=("Courier", 5, "normal"))
pen.goto(0, 100)
pen.write("Raccogli tantissima energia blue e cerca di resistere", align="center", font=("Courier", 5, "normal"))
pen.goto(0, 50)
pen.write("velocità e gestone dei missili.", align="center", font=("Courier", 5, "normal"))
pen.goto(0, 0)
pen.write("UTILIZZA IL GIOCO PER CAPIRCI ALTRO SUI MISSILI.", align="center", font=("Courier", 5, "normal"))
wn.update()
time.sleep(5)
